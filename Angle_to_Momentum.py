...
from Initial_Values import t_0, r_0, phi_0, theta_0, t_0_Geo, r_0_Geo, phi_0_Geo, theta_0_Geo
...
def Screen_to_Momentum_Forwards(x:float, y:float)->tuple: # A diferencia del otro este arregla los menos de calcular la trayectoria hacia atrás en el tiempo
    ...
    coords_0=(t_0_Geo, r_0_Geo, phi_0_Geo, theta_0_Geo) # Tupla de coordenadas iniciales
    ...
    ps_local_r=-1
    ps_local_phi=(x*ps_local_r)/r_0_Geo # Teóricamente debería de tener un menos, a diferencia del caso de generar una imagen no lo
                                     #recibimos espejado por lo que lo escribimos explícitamente.
    ps_local_theta=(y*ps_local_r)/r_0_Geo
