...
def Screen(r_0, M):  # Calculo del tamaño de la pantalla
    ...
    # Multiplicamos por 4 para que haya espacio para verlo bien
...
def main():
    ...
    # Esto hay que cambiarlo depende del numero de trabajadores o de zonas que te quieras centrar
    N_pix_little = int(N_pix/2)
